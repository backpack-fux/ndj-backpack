...
interface Props {
  ...
  outerEyeStyle: 'square' | 'circle' | 'diamond' | 'rounded';
...
//-----------------------------Component---------------------------------
export class QRCode extends PureComponent<Props> {
  static defaultProps = {
    content: 'No Content',
    size: 250,
    padding: 1,
  ...
  getPiece(x: number, y: number, modules: any) {
  ...
  getPieceProperties(x: number, y: number, modules: any) {
    var mod_matrix: any = {};
